    ...
    <>
      <footer className="bg-tinta px-6 py-12 text-hueso">
        <div className="mx-auto max-w-5xl">
          <p className="font-display text-2xl text-rosa">HACHI</p>
          ...
          <div className="mt-6 flex flex-wrap gap-6 font-mono text-xs uppercase tracking-widest">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="underline underline-offset-4 hover:text-lima"
            >
            ...
            <a href="#donar" className="underline underline-offset-4 hover:text-lima">
              Donar
            </a>
          </div>
        </div>
      ...
      {mostrarBarra && (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t-2 border-rosa-claro bg-papel p-3 md:hidden">
          <a href="#donar" className="block w-full rounded-full bg-rosa-oscuro py-3 text-center font-mono text-sm uppercase tracking-wide text-hueso shadow-soft">
            Donar
          </a>
        </div>
      )}
